...
| English text description covers features, functionality, technologies, data sources, findings and learnings | [Rules, section 7.B](https://agentic-cinema.devpost.com/rules) | Finalised [`DEVPOST_PROJECT_PAGE.md`](DEVPOST_PROJECT_PAGE.md) copied to Devpost | Ready | Submission editor | The repository story is aligned with the supplied Devpost copy; compare it with the final demo before release. |

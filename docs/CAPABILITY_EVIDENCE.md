...
2026 against `origin/main` at `64ee654a999549322dbeea22f9ffc2b8b29acdaf` and
the public product at [memorydirector.com](https://memorydirector.com/).
...
| Share video through the native share sheet, with a save-first fallback | Verified | Automated API behaviour verified | Completion and cancellation pending ST-52 | Final recording may show only verified behaviour | [Production wizard](../apps/web/src/components/ProductionWizard.tsx), [wizard tests](../apps/web/src/components/ProductionWizard.test.tsx) |
...
| Four-layer usage and cost controls | Verified | Workflow/configuration evidence verified | Not required | Evidence ready; no instant billing guarantee | [Usage and cost controls](operations/USAGE_COST_CONTROLS.md), [deployment workflow](../.github/workflows/deploy.yml) |
...
| Rights-cleared final demo media | Register exists | Not applicable | Not applicable | Pending ST-9 | [Media rights register](demo/MEDIA_RIGHTS_REGISTER.md) — Yvonne |
...
| Devpost entry and submission confirmation | Draft package exists | Not applicable | Not applicable | Pending ST-17 | [Submission checklist](submission/SUBMISSION_CHECKLIST.md), [evidence package](submission/EVIDENCE_PACKAGE.md) — Yvonne |

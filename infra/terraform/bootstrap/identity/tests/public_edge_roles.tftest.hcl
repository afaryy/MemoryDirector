...
run "grants_only_the_required_public_edge_compute_roles" {
  ...
  assert {
    ...
    error_message = "The GitHub Terraform deployer may receive only the scoped Compute roles required to manage the public load balancer and Cloud Armor policy."
  }
}

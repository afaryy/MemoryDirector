...
output "media_lifecycle_rules" { value = module.media_bucket.lifecycle_rules }
output "quota_firestore_database" { value = google_firestore_database.quota.name }
output "runtime_project_roles" { value = ["roles/aiplatform.user", "roles/datastore.user"] }
